...
- Comments support Photon capsules via `photon_capsule`, `photon_bytes`, `photon_mode`, and `photon_encoding` columns. Photon comments do not cache generated audio in `audio_data`, keeping storage tiny and regenerating audio on play.
